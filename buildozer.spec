...
# (str) Package name
package.name = imageuploader

# (str) Package domain (needed for android/ios packaging)
package.domain = com.eehaiou
...
source.include_exts = py,png,jpg,kv,ttf,ttc,gif,webp,bmp
...
requirements = python3==3.11.6,hostpython3==3.11.6,kivy==2.2.0,requests,plyer
p4a.branch = master
...
#android.gradle_dependencies = org.gradle.jvmargs=-Xmx2048m
